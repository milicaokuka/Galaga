...
@REM #
ngdbuild -p xc6slx45fgg676-2 -nt timestamp -bm battle_city.bmm "D:/ra223-2014/Galaga/battle_city_design/implementation/battle_city.ngc" -uc battle_city.ucf battle_city.ngd 
